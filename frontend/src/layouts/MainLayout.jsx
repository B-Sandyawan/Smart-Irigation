...
const MainLayout = () => {
  return (
    ...
    <div className="h-screen w-screen overflow-hidden bg-transparent font-sans overscroll-none relative">
      <AnimatedBackground />
      ...
      */}
      <main className="relative z-10 h-full w-full pb-[100px] md:pb-0 md:pl-[116px] lg:pl-[124px] [&>*]:!h-full">
        <Outlet />
      </main>
